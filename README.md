...
<html>
  ...
  <body>
    <div class="box">
      <h1>Quer jogar ?</h1>
      <div class="buttons">
        <button class="button button-1" id="sim">Não</button>
        <button class="button button-2" id="nao">Sim</button>
      </div>
    </div>
  </body>
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      ...
      simButton.addEventListener("click", function () {
        alert("Você nunca vai ganhar de mim, SEU PERDEDOR 😂!");
      });
